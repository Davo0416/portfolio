        ...
        <HeroContent>
          <div>
            ...
            <Description role="paragraph">
              I’m passionate about building useful software, learning new technologies, making apps that easy to use, and finding simple ways to solve difficult problems with clean code.
            </Description>
            <SocialLinks role="list" aria-label="Social media links">
              ...
              <a 
                href="https://www.linkedin.com/in/gevorgyandavid/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="mailto:davogevo0416@gmail.com"
